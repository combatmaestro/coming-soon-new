...
- Search [issues](https://github.com/imfsiddiqui/Revelist/issues) to check if the
...
- Search [issues](https://github.com/imfsiddiqui/Revelist/issues) for similar
  feature requests.
...
- **Fork** the repository.
- **Clone** your fork: `git clone https://github.com/<your-username>/Revelist.git`.
